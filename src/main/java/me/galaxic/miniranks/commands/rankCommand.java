                ...
                if (args.length == 0) {
                    ...
                    if (args[0].equalsIgnoreCase("set")) {
                                    ...
                                    if (player.getServer().getPlayer(playerTarget) != null) {
                                        ...
                                        if (miniranks.getRankManager().checkRank(rank)) {
                                            try {
                                                ...
                                                target.sendMessage(ChatColor.GREEN.toString() + ChatColor.BOLD + "Please rejoin to receive your rank!");
                        ...
                        if (args.length == 4) {
                            ...
                            if (miniranks.getRankManager().checkRank(rank)) {
                                miniranks.getRankManager().updateRank(rank, newRank, newPrefix);
                                player.sendMessage(ChatColor.GREEN + "Successfully updated " + rank);
                            } else {
                        ...
                        player.sendMessage(ChatColor.GREEN + "/rank edit <rank> <newRank> <newPrefix>");
