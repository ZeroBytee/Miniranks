...
public class rankTab implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 1) {
            return StringUtil.copyPartialMatches(args[0], Arrays.asList("set", "create", "delete", "perms", "help", "edit"), new ArrayList<>());
            ...
            if (args[0].equalsIgnoreCase("set")) {
                ...
                return StringUtil.copyPartialMatches(args[1], Collections.singletonList("<newRank>"), new ArrayList<>());
            }
        } else if (args.length == 4) {
            if (args[0].equalsIgnoreCase("edit")) {
                // get all the ranks from the database and for each rank, add it to the list
                return StringUtil.copyPartialMatches(args[1], Collections.singletonList("<newPrefix>"), new ArrayList<>());
            }
        }
